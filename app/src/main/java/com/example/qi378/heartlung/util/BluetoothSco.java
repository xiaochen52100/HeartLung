...
public class BluetoothSco {
    ...
    private String TAG = "BluetoothSco";

    private static BluetoothSco mBluetoothUtil;
    ...
    public static BluetoothSco getInstance(Context context) {
        ...
        if (mBluetoothUtil == null) {
            mBluetoothUtil = new BluetoothSco();
        }
    ...
    public IBluetoothConnectListener mBluetoothConnectListener;
}
